...
//TIEMPO CICLOS MISMO PARA TODOS LOS MODOS
...
int acceleratorControlFunction()
{
	...
	if (speed > meanSpeed) { //Si velocidad mayor de 55 (modo normal) o 2.5 (modo frenado)
		// request GAS CLR
...
{    
	while(1){
		...
		//printf("\n~~~~~~~~~~~~~~~~~~~~~ MODO FRENADO ~~~~~~~~~~~~~~~~~~~~~\n");
		mode = 1; //modo de frenado
		brakeMode();
		
		//printf("\n~~~~~~~~~~~~~~~~~~~~~ MODO PARADA ~~~~~~~~~~~~~~~~~~~~~\n");
		mode = 2; //modo de parada
		stopMode();
